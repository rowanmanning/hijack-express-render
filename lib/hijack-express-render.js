/**
 * @rowanmanning/hijack-express-render module
 * @module @rowanmanning/hijack-express-render
 */
'use strict';
 ...
 *     Returns nothing.
 */
module.exports = function hijackExpressRender(app, newRenderMethod) {
	app.render = function render(...params) {
		const {view, options, callback} = defaultRenderParams(...params);
